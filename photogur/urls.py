...
from photogur.views import pictures_page, picture_show, picture_search, create_comment, login_view, logout_view, signup, new_picture, home, edit_picture
...
urlpatterns = [
    ...
    path('picture/<int:id>/edit/', edit_picture, name='edit_picture'),
